...
onBeforeMount(() => {
  ...
  if (refCode) {
    ...
    affiliationMessage.value = 'Você está se registrando com um código de afiliação.';
  }
});
</script>
...
<template>
  <div class="flex justify-center items-center min-h-[80vh]">
    <div class="w-full max-w-md">
      ...
      <div v-if="affiliationMessage" class="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-md text-blue-700 text-sm">
        ...
        <p class="mt-1 text-xs text-blue-600">
          Código: <span class="font-mono font-medium">{{ affiliateCode }}</span>
        </p>
      </div>
