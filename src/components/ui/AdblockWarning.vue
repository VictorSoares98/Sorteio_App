...
<template>
  <transition name="fade">
    <div 
      v-if="isVisible" 
      class="fixed bottom-4 right-4 z-50 p-4 bg-yellow-50 border border-yellow-200 rounded-lg shadow-lg max-w-md"
    >
      <div class="flex items-start">
        ...
        <div class="ml-3">
          <h3 class="text-sm font-medium text-yellow-800">Bloqueio de Firestore detectado</h3>
          <div class="mt-1 text-xs text-yellow-700">
            <p>Um bloqueador de anúncios ou extensão está impedindo a conexão com o Firestore, afetando a sincronização em tempo real.</p>
